...
from app.schemas.cita import CitaResponse, CitaCreate, CitaUpdate, CitaPatch
from app.schemas.inventario import InventarioRespuesta, InventarioCrear, InventarioActualizar, ParcheInventario
...
__all__=["RespuestaMascota", "CrearMascota", "ParcheMascota", "ActualizarMascota", "RespuestaVeterinario", "CrearVeterinario", "ParcheVeterinario",
        ...
        "TratamientoUpdate", "TratamientoPatch", "TratamientoResponse", "CitaResponse", "CitaCreate", "CitaUpdate", "CitaPatch", "InventarioRespuesta", "InventarioCrear", "InventarioActualizar", "ParcheInventario"
        ]
